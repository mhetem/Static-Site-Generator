...
class TestTextToHtml(unittest.TestCase):
    ...
    def test_textlink(self):
        ...
        self.assertEqual(html_node.value, "This is a text node")
        self.assertEqual(html_node.props, {"href": "this is an url"})

    def test_textimage(self):
        node = TextNode("This is a text node", TextType.IMAGE, "this is a link")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {"src": "this is a link", "alt": "This is a text node"})